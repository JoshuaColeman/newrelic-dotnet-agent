...
namespace MultiverseScanner
{
    public class InstrumentationValidator
    {
        ...
        private void CheckMatch(AssemblyModel assemblyModel, InstrumentationModel instrumentationModel, AssemblyReport instrumentationReport)
        {
        ...
        private bool ValidateAssembly(AssemblyModel assemblyModel, Match match, AssemblyReport instrumentationReport)
        {
        ...
        private void ValidateClass(AssemblyModel assemblyModel, Match match, AssemblyReport instrumentationReport)
        {
        ...
        private void CheckExactMethodMatchers(AssemblyReport instrumentationReport, Match match, ClassModel classModel)
        {
        ...
        private void MarkAllMethodsAsNotValid(Match match, AssemblyReport instrumentationReport)
        {
