...
namespace ConsoleScanner
{
    public class Program
    {
        ...
        private static void ProcessAssemblies(ScannerConfiguration configuration)
        {
        ...
        private static InstrumentationModel ReadInstrumentationFile(InstrumentationSet instrumentationSet)
        {
        ...
        private static ScannerConfiguration ReadConfigFile(string filePath)
        {
        ...
        private static List<string> GetNugetPackages(string name, string[] versions, List<string> instrumentationAssemblies)
        {
        ...
        private static List<string> GetNugetAssemblies(InstrumentationSet instrumentationSet, List<string> instrumentationAssemblies)
        {
        ...
        private static List<string> GetLocalAssemblies(InstrumentationSet instrumentationSet)
        {
